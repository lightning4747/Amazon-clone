...
class Clothing extends Product {
  ...
  extraInfo() {
    ...
    <a href="${this.sizeChartLink}" target="_blank" style="text-decoration: none; color: black; border: 2px solid black; display: inline; width: 80px;">Size Chart</a>
...
console.log(tshirt, tshirt.getPrice());
